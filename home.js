...
//CODE HERE
const replaceDeals = (newDiscount) => {
    return deals[0].title = deals[0].title.replace('15% Off!', newDiscount)
}

//Use this to check my code 
// replaceDeals('10% Off!')
// console.log(deals)
...
//CODE HERE
const replaceMonth = (newMonth) => {
    return deals[1].desc = deals[1].desc.replace('March', newMonth)
}
const noWhiteSpace = () =>{
    return deals[1].desc = deals[1].desc.trim()
}


//check my code with this
// replaceMonth('April')
// noWhiteSpace()
// console.log(deals)